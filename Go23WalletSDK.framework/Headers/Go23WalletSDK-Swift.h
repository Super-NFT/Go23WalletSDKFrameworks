...
#ifndef GO23WALLETSDK_SWIFT_H
#define GO23WALLETSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Go23WalletSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13Go23WalletSDK15Go23ProgressHUD")
@interface Go23ProgressHUD : UIView
...
SWIFT_CLASS("_TtC13Go23WalletSDK13Go23WalletSDK")
...
SWIFT_CLASS("_TtC13Go23WalletSDK15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(Go23WalletSDK)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(Go23WalletSDK)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(Go23WalletSDK)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(Go23WalletSDK)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(Go23WalletSDK)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC13Go23WalletSDK12TaskDelegate")
